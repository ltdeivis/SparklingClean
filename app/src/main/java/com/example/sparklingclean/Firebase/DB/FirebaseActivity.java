    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        writeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText refTxt = (EditText) findViewById(R.id.referenceTxt);
                EditText contentTxt = (EditText) findViewById(R.id.contentTxt);

                String ref = refTxt.getText().toString();
                String cont = contentTxt.getText().toString();

                tester.testWriteToDB(ref, cont);
            }
        });
    }
